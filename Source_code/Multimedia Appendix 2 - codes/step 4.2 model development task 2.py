...
def get_roc_curve(y_score, y_true, ds = 'SH'):
    ...
    plt.title('Task 2: cholesteatoma vs non-cholesteatoma {} fold {}'.format(ds, fold_num))
    plt.legend(loc="best")
...
# Define callbacks.
chckpnt_path = r"C:\Users\liy45\Desktop\3d_image_classification_task2_fold{}.h5".format(fold_num)
...
df_result.to_excel(r'C:\Users\liy45\Desktop\Result_sh_fold{}.xlsx'.format(fold_num), index=False)
...
fold_num = 5
chckpnt_path = r"D:\OneDrive - VUMC\Research\Ongoing Research Projects\My AI projects\AI 3D otitis media\Tasks updated 2022-09-03\Results task 2 updated 9-21-22\fold {}\3d_image_classification_task2_fold{}.h5".format(fold_num, fold_num)
# model = get_model(width=128, height=128, depth=32)
# model.summary()
model.load_weights(chckpnt_path)
