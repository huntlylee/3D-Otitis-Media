...
# plot_tf_data(train_dataset, num_case = 8)
# plot_tf_data(validation_dataset, num_case = 8)
...
# Define callbacks.
chckpnt_path = r"C:\Users\liy45\Desktop\Task1_model_2d_fold{}.h5".format(fold_num)
...
try:
    with pd.ExcelWriter(r'C:\Users\liy45\Desktop\Result_SH_T1_2dCNN.xlsx',  mode='a', if_sheet_exists = 'replace') as writer:  
        df_result.to_excel(writer, sheet_name = 'fold{}'.format(fold_num), index=False)
except:
    df_result.to_excel(r'C:\Users\liy45\Desktop\Result_SH_T1_2dCNN.xlsx', sheet_name = 'fold{}'.format(fold_num), index=False)
...
chckpnt_path = r"D:\OneDrive - VUMC\Research\Ongoing Research Projects\My AI projects\AI 3D otitis media\2dCNN\Task 1\Task1_model_2d_fold{}.h5".format(fold_num)
...
df_sh = pd.read_excel(r'D:\OneDrive - VUMC\Research\Ongoing Research Projects\My AI projects\AI 3D otitis media\2dCNN\Task 1\Result_SH_T1_2dCNN.xlsx',
...
try:
    with pd.ExcelWriter(r'C:\Users\liy45\Desktop\Result_WH_T1_2dCNN.xlsx',  mode='a', if_sheet_exists = 'replace') as writer:  
        df_result_wh.to_excel(writer, sheet_name = 'fold{}'.format(fold_num), index=False)
except:
    df_result_wh.to_excel(r'C:\Users\liy45\Desktop\Result_WH_T1_2dCNN.xlsx', sheet_name = 'fold{}'.format(fold_num), index=False)



plot_test_slices(images_np_wh, df_result_wh, case_selection = 4)
...
df_result = pd.read_excel(r'D:\OneDrive - VUMC\Research\Ongoing Research Projects\My AI projects\AI 3D otitis media\2dCNN\Task 1\Result_{}_T1_2dCNN.xlsx'.format(ds), 
