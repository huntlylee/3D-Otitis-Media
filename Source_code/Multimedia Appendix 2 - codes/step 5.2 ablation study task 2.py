...
# df_lbl_sh['Cholesteatoma'] = df_lbl_sh['Task 1 label 9-3-22'].astype(int)
...
# Define callbacks.
chckpnt_path = r"C:\Users\liy45\Desktop\Task2_model_{}_fold{}.h5".format(model_num, fold_num)
...
try:
    with pd.ExcelWriter(r'C:\Users\liy45\Desktop\Result_SH_T2_M{}.xlsx'.format(model_num),  mode='a', if_sheet_exists = 'replace') as writer:  
        df_result.to_excel(writer, sheet_name = 'fold{}'.format(fold_num), index=False)
except:
    df_result.to_excel(r'C:\Users\liy45\Desktop\Result_SH_T2_M{}.xlsx'.format(model_num), sheet_name = 'fold{}'.format(fold_num), index=False)
...
chckpnt_path = r"D:\OneDrive - VUMC\Research\Ongoing Research Projects\My AI projects\AI 3D otitis media\Ablation study\Task 2\Task 2 fold {}\Task2_model_{}_fold{}.h5".format(fold_num,model_num,fold_num)
...
df_sh = pd.read_excel(r'D:\OneDrive - VUMC\Research\Ongoing Research Projects\My AI projects\AI 3D otitis media\Ablation study\Task 2\Result_SH_T2_M{}.xlsx'.format(model_num),
...
try:
    with pd.ExcelWriter(r'C:\Users\liy45\Desktop\Result_WH_T2_M{}.xlsx'.format(model_num),  mode='a', if_sheet_exists = 'replace') as writer:  
        df_result_wh.to_excel(writer, sheet_name = 'fold{}'.format(fold_num), index=False)
except:
    df_result_wh.to_excel(r'C:\Users\liy45\Desktop\Result_WH_T2_M{}.xlsx'.format(model_num), sheet_name = 'fold{}'.format(fold_num), index=False)
...
df_result = pd.read_excel(r'D:\OneDrive - VUMC\Research\Ongoing Research Projects\My AI projects\AI 3D otitis media\Ablation study\Task 2\Result_{}_T2_M{}.xlsx'.format(ds, model_num), 
