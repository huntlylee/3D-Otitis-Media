...
# Load model
chckpnt_path = r"D:\OneDrive - VUMC\Research\Ongoing Research Projects\My AI projects\AI 3D otitis media\Tasks updated 2022-09-03\Results task 2 updated 9-21-22\fold 1\3d_image_classification_task2_fold1.h5"
model.load_weights(chckpnt_path)
model.summary()

last_conv_layer_name = "conv3d_11"

scan_id = 'p00483000-190522-Left'
dataset = 'Shanghai' #'Wuhan 220221'
